...
yc_secret_key yc_secret_key = os.getenv('YC_SECRET_KEY')
api_key = yc_secret_key = os.getenv('API_KEY')
api_secret = yc_secret_key = os.getenv('API_SECRET')
...
def main(): #ticker	
    ...
    with open('linear_regression_model-act.pkl', 'rb') as file:
